...
for ii = 1:num_n
    ...
    x_0   = x_init(ii+9, ~isnan(x_init(ii+9,:)));
    x_temp = x_0;
    ...
    fprintf('evaulated obj = %.8g (iter_used=%d)\n', obj_val(ii), i_last);
end

save('test_experiment_results.mat', 'n_values', 'obj_val', 'x_temp_last');
